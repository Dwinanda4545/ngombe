    ...
    <main id="main">
        ...
        <div class="breadcrumbs" style="background-color: #4B898F;">
            <div class="container" style="padding-top:50px; padding-bottom:50px">
                <h2><b>Sign In</b></h2>
                <p>You are not logged into your account yet!
                </p>
            </div>
        </div><!-- End Breadcrumbs -->
        ...
        <section id="contact" class="contact">
          <div data-aos="fade-up">
            <div class="col-lg-12 mt-5 mt-lg-0" style="align-items: center;">
                <form action="assets/vendor/phpemailform/proses_login.php" method="POST" role="form" style="width: 30%; margin: 0 35%;">
                    <div class="form-group mt-3">
                        <input type="text" class="form-control" name="loginemail" placeholder="Email" required></input>
                    </div>
                    <div class="form-group mt-3">
                        <input type="password" class="form-control" name="loginpass" placeholder="Password" required></input>
                    </div>
                    <br>

                    <h5>Forget your password <a style="color:#4b898f" href="forget_pass.php">Click Here</a></h5>
                    <h5>Don't have an account ? <a style="color:#4b898f" href="regist.php">Create now</a></h5>

                    <br>
                    <div class="text-center"><button class="btn btn-primary btn-lg" type="submit" style="background: #23716f;">Login</button></div>
                </form>
